...
export const employees: EmployeeData[] = [
  ...
  { name: "Laurentiu Stoica", calendarId: 122, userId: 170, phoneNumber: "40316316842", phonePrivateNumber: generateGenericPrivateNumber(25), email: "laurentiu.stoica@renet.com" },
